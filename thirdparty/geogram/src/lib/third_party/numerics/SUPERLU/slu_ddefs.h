...
extern void NUMERICS_API dgstrf (superlu_options_t*, SuperMatrix*,
...
extern void    dFillRHS (trans_t, int, double *, int, SuperMatrix *,
                          SuperMatrix *);
extern void NUMERICS_API dgstrs (trans_t, SuperMatrix *, SuperMatrix *, int *, int *,
