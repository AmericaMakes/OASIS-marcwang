...
#include <third_party/numerics/linkage.h> /* [BL] to export symbols using NUMERICS_API */
...
extern int     NUMERICS_API input_error(char *, int *);

extern void    NUMERICS_API Destroy_SuperMatrix_Store(SuperMatrix *);
extern void    NUMERICS_API Destroy_CompCol_Matrix(SuperMatrix *);
extern void    NUMERICS_API Destroy_CompRow_Matrix(SuperMatrix *);
extern void    NUMERICS_API Destroy_SuperNode_Matrix(SuperMatrix *);
extern void    NUMERICS_API Destroy_CompCol_Permuted(SuperMatrix *);
extern void    NUMERICS_API Destroy_Dense_Matrix(SuperMatrix *);
extern void    NUMERICS_API get_perm_c(int, SuperMatrix *, int *);
extern void    NUMERICS_API set_default_options(superlu_options_t *options);
extern void    NUMERICS_API ilu_set_default_options(superlu_options_t *options);
extern void    NUMERICS_API sp_preorder (superlu_options_t *, SuperMatrix*, int*, int*, SuperMatrix*);
...
extern int     NUMERICS_API sp_ienv (int);
...
extern void    NUMERICS_API StatInit(SuperLUStat_t *);
extern void    StatPrint (SuperLUStat_t *);
extern void    NUMERICS_API StatFree(SuperLUStat_t *);
