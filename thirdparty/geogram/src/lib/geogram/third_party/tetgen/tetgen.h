...
// and set the pointers to nullptrs.                                            //
//                                                                           //
///////////////////////////////////////////////////////////////////////////////

class GEOGRAM_API tetgenio {
...
class GEOGRAM_API tetgenbehavior {
...
// [Bruno] Moved prototypes for Shewchuk's predicates to sourcefile,
// with #ifdef USE_PCK toggle for using PCK predicates instead.
...
void GEOGRAM_API tetrahedralize(tetgenbehavior *b, tetgenio *in, tetgenio *out, 
