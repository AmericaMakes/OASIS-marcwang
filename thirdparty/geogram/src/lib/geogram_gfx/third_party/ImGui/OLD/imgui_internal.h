...
#pragma clang diagnostic ignored "-Wc++98-compat-pedantic" // [Bruno Levy]
...
#pragma GCC diagnostic ignored "-Wc++98-compat-pedantic"    // [Bruno Levy]    
#endif
...
namespace ImGui
{
    ...
    // FIXME: Eventually we should aim to move e.g. IsActiveIdUsingKey() into IsKeyXXX functions.
     // [Bruno Levy] silenced warnings: 1 << dir --> 1u << dir (and also 1u << input)    
    inline bool             IsActiveIdUsingNavDir(ImGuiDir dir)                         { ImGuiContext& g = *GImGui; return (g.ActiveIdUsingNavDirMask & (1u << dir)) != 0; }
    inline bool             IsActiveIdUsingNavInput(ImGuiNavInput input)                { ImGuiContext& g = *GImGui; return (g.ActiveIdUsingNavInputMask & (1u << input)) != 0; }
