...
#ifndef __ANDROID__ // [Bruno Levy]

#include "imgui.h"
#include "imgui_impl_glfw.h"

// GLFW
// [Bruno Levy] adapted to geogram glfw compile
...
#define GLFW_HAS_FOCUS_ON_SHOW        0 // [Bruno] (GLFW_VERSION_MAJOR * 1000 + GLFW_VERSION_MINOR * 100 >= 3300) // 3.3+ GLFW_FOCUS_ON_SHOW
#define GLFW_HAS_MONITOR_WORK_AREA    0 // [Bruno] (GLFW_VERSION_MAJOR * 1000 + GLFW_VERSION_MINOR * 100 >= 3300) // 3.3+ glfwGetMonitorWorkarea
...
// [Bruno Levy] 01/06/2017 Do not use GLFW3 clipboard under emscripten, use built-in
...
#endif // __EMSCRIPTEN__ [Bruno Levy] 01/06/2017 
...
void ImGui_ImplGlfw_Shutdown()
{
    ...
    // [Bruno Levy] Nov 26 2019: removed to have previous behavior
...
static void ImGui_ImplGlfw_UpdateMonitors()
{
#ifdef __EMSCRIPTEN__ // [Bruno Levy]
    return;
#endif    
